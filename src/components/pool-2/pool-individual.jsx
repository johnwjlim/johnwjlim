          ...
          <Row>
            ...
            <Col>
              ...
              <SectionText style={{color: "#fff"}}>
                ...
                Water level on display affords for an easier visual reference for skimability. Also helpful for users who may struggle to read text or numbers without the aid of corrective lenses in a bathroom environment.
            </SectionText>
            </Col>
          </Row>
        </div>
