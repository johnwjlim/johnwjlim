...
const SpecialWrapper = styled(Styled.ImageWrapper)`
...
const PrototypeText = styled(Styled.TextBlock)`
  max-width: 28rem;
...
export default function Showcase(props) {
  ...
  return (
    <Waypoint onEnter ={() => props.onChange(0)}>
      <Styled.Container id="overview">
        <Styled.ImageWrapper>
