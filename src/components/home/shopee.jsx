...
export default function GThumbnail() {
  const data = useStaticQuery(graphql`
    query {
      HeroImage: file(relativePath: {eq: "shopee-hero.jpg"}) {
        childImageSharp {
  ...
  return (
    <CaseLink as="a"
      href="https://www.figma.com/proto/ReY1OCiwWRK3jyhZCrXhnc/Shopee-Design-Test-%E2%80%93-John-Lim?node-id=217%3A0&scaling=scale-down"
      target="_blank"
    >
      <ImageParent
        ...
        <Img fluid={data.HeroImage.childImageSharp.fluid} />
        {
          transitions.map(({item, key, props}) => 
            item && <animated.div key={key} style={props}>
              <Filler>
                <ImageCaption>How might we enable financial empowerment for one of the most rapidly developing societies in the world?</ImageCaption>
              </Filler>
      ...
      <CaseCaption>
        Helping people say yes to more of the things they love
      </CaseCaption>
      <CaseCaption style={{marginTop: "0.2rem", fontWeight: "400"}}>Shopee Credit Loans</CaseCaption>
    </CaseLink>
  )
